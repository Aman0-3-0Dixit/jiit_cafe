...
export default function Stock () {
  ...
  useEffect(() => {
    fetch('http://192.168.193.204:3000/adminAuth/stockfetch')
  ...
  const handleAddStock = async (itemId) => {
    ...
    try {
      ...
      const response = await fetch('http://192.168.193.204:3000/adminAuth/addStock', {
        method: 'POST',
        headers: {
  ...
  const handleDeleteStock = async (itemId) => {
    ...
    try {
      ...
      const response = await fetch('http://192.168.193.204:3000/adminAuth/deleteStock', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
