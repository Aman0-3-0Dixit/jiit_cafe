          ...
          pendingOrders.map((order) => (
            <Card key={order.orderId} containerStyle={{ width: '100%', marginBottom: -17, backgroundColor: '#AAAAAA', paddingBottom: 25 }}>
              <View>
                ...
                <TouchableOpacity style={{ borderColor: 'black', borderWidth: 1, width: 45, height: 45, backgroundColor: '#0000FF', position: 'absolute', top: 35, left: 270 }} onPress={() => handleCompleteOrder(order.orderId, order.orderedBy[0].enrollmentNo)}>
                </TouchableOpacity>
              </View>
            </Card>
          ))
